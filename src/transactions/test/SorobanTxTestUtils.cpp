...
{
    ContractExecutable executable(CONTRACT_EXECUTABLE_HCNET_ASSET);
    return executable;
}
                            ...
                            uint32_t inclusionFee)
{
    ...
    if (executable.type() !=
        ContractExecutableType::CONTRACT_EXECUTABLE_HCNET_ASSET)
    {
...
{
    return hcnet::contractDataKey(mAddress, key, durability);
}
